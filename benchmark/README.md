...
choose a model or a server flag, the second to confirm the whole system.
...
**This is decode-dominated, and HINDSIGHT.md's "Prefill dominates the LLM cost"
...
HINDSIGHT.md records that raising it is net worse end to end. Its recorded
